...
class ExampleUnitTest {
  ...
  fun testIncrementalVersionCheck() {
    // Test newer patch versions against v1.2.2
    assertTrue(com.example.util.GitHubUpdateManager.isNewerVersion("v1.2.3", "v1.2.2"))
    assertTrue(com.example.util.GitHubUpdateManager.isNewerVersion("1.3.0", "v1.2.2"))
    assertTrue(com.example.util.GitHubUpdateManager.isNewerVersion("v2.0.0", "v1.2.2"))
    assertTrue(com.example.util.GitHubUpdateManager.isNewerVersion("v1.2.2.1", "v1.2.2"))

    // Test same or older versions
    assertFalse(com.example.util.GitHubUpdateManager.isNewerVersion("v1.2.2", "v1.2.2"))
    assertFalse(com.example.util.GitHubUpdateManager.isNewerVersion("1.2.2", "1.2.2"))
    assertFalse(com.example.util.GitHubUpdateManager.isNewerVersion("v1.2.1", "v1.2.2"))
    assertFalse(com.example.util.GitHubUpdateManager.isNewerVersion("v1.1.9", "v1.2.2"))
    assertFalse(com.example.util.GitHubUpdateManager.isNewerVersion("v1.0.0", "v1.2.2"))
  }
